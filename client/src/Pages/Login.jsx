  ...
  return (
    <div id='loginpage'>
      ...
      <div className='log p-5'>
        ...
        <div class="input-group mb-3 inpname ">
          <input type="text" class="form-control" placeholder="Password" aria-label="Recipient's username" aria-describedby="basic-addon2"></input>
        ...
        <Link to="/signup" id='loginlink' >Not Have an Account ?</Link>
        </form>
      </div>
